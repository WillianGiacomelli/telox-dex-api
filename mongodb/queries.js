...
db.pokemons.find(
  { attack: { $gt: 70 }, speed: { $gt: 60 } },
  { name: 1, attack: 1, speed: 1, hp: 1 }
);
...
db.pokemons.find(
  { $or: [{ hp: { $lt: 60 } }, { defense: { $lt: 60 } }] },
  { name: 1, hp: 1, defense: 1 }
);
...
db.pokemons.find(
  { type1: { $in: ["psychic", "fighting", "fire"] } },
  { name: 1, is_legendary: 1, type1: 1, _id: 0 }
);
